  ...
  return (
    <Layout>
            ...
            <div className={styles.linkField}>
              <div className={styles.linkFieldInput}>
                <Form.Item name="link" noStyle rules={[{
                  ...
                  <Input placeholder="https://my-super-long-link.com/blah-blah-blah-blah-blah-blackShip-blackShip-blackShip-blackShip-blackShip" size="large"/>
                </Form.Item>
              </div>
      ...
      <Footer className={styles.footer}>
        Sneha Ghosh (@Technical_Isopod_075) &copy; 2025
      </Footer>
    </Layout>
  )
}
